...
export default function SignUpScreen() {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      // Always attempt to create profile via RPC (RLS safe)
      // This handles both immediate session creation and email confirmation flows
      ...
      if (rpcError) {
        logger.error("Profile creation failed", rpcError, {
          component: "SignUpScreen",
          userId: authData.user.id,
        });
        // Don't return here - continue with signup even if profile creation fails
        // The RLS trigger should handle profile creation on first login
